...
use Joomla\CMS\Image\Filter\SuperBrightness;
...
class PlgSystemImageFilterTest extends CMSPlugin
{
	...
	public  function checkDefaultImageClass($type)
	{
		...
		$serviceRegistry->register("superbrightness", SuperBrightness::class);
	 ...
	 *
	 */
	public function overwriteServiceRegistryFilter($serviceRegistry)
	{
		$serviceRegistry->register("superbrightness", Filter\SuperBrightness::class);
